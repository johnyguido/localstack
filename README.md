# Projeto de estudo sobre Spring Boot com Localstack

Projeto de estudo para acompanhando das aulas do canal do Professor Thomás da Costa onde é criada uma aplicação 
com Spring Boot que funciona com os recursos do LocalStack e da AWS. 
